...
import {Expo,Power3,Back} from "gsap/gsap-core";

export function WelcomeSVG () {


    useEffect(()=>{
        drawSVG('.welcome svg.Hello-World path',2)
    },[])
            ...
            gsap.to(path,{
                ...
                onComplete:()=>{
                    gsap.to(path,{
                        ...
                        duration: 2,
                        ease: Expo.easeIn,})
                    gsap.to('.welcome svg.Hello-World path.st0',{
                        fill: '#ea8823',
                        duration: 2,
                        ease: Expo.easeIn,
                        onComplete: ()=>{
  ...
  return (
      <div className={'welcome_svg-holder'}>
          <svg className={'Hello-World'} version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
               viewBox="0 0 432 432" style={{disableBackground:'new 0 0 432 432'}} >
              <g>
	<g>
		<path strokeWidth='1' stroke='white' d="M212.2,198.5c-1,1.1-2,2.1-3,3.1c-1.6,1.5-3.4,2.8-5.4,3.8c-4.3,2.1-9.3,1.5-12.8-1.8c-1.3-1.2-2.3-2.6-3.1-4.2
        ...
        <g>
			<path strokeWidth='1' stroke='white' d="M149,222.9c-0.5,1.5-0.9,2.9-1.3,4.4c-1.7,6.5-3.4,13.1-5.2,19.6c-1.2,4.6-2.5,9.2-3.8,13.7c-0.2,0.7-0.5,1.4-0.8,2
            ...
            <path strokeWidth='1' stroke='white' d="M291,241.4c0.2-0.7,0.5-1.5,0.7-2.2c2.2-6.5,5.3-12.4,9.4-17.9c1.7-2.2,3.5-4.3,5.6-6.1c1-0.8,2.1-1.4,3.4-1.7
            ...
            <path strokeWidth='1' stroke='white' d="M234.8,253.8c0.5,0.3,1,0.6,1.5,1c2.1,1.5,3.8,3.3,5.1,5.3c1.6,2.6,3,5.3,4.6,7.9c0.5,0.8,0.9,1.7,1.4,2.5
            ...
            <path strokeWidth='1' stroke='white' d="M217.4,241.1c-0.1,5.1-1,10.4-2.4,15.5c-0.9,3.4-2.2,6.7-4,9.7c-1,1.7-2.3,3.3-3.8,4.5c-2.7,2.1-5.4,2.1-8.1,0.3
            ...
            <path strokeWidth='1' stroke='white' d="M263.1,270.9c0.7,0,1.4,0,2-0.1c4.2-0.7,8.4-1.4,12.6-2.2c0.4-0.1,0.8-0.2,1.3-0.1c0.2,0,0.5,0.2,0.6,0.4
				...
				c-0.2,2.5-0.3,5-0.6,7.6c-0.5,6.2-1.1,12.5-1.6,18.7c-0.2,2.2-0.6,4.4-0.9,6.6C263.2,270,263.1,270.3,263.1,270.9z"/>
                  ...
                  <g>
		<path strokeWidth='1' stroke='#ea8823' className="st0" d="M391.9,257c-0.3-0.3-0.7-0.6-1.1-0.9c-4.2-3.1-8.6-5.9-13-8.8c-3.6-2.4-7.3-4.8-11.1-6.9
			...
			c1.9-0.2,3.9-0.5,5.7-1c0.7-0.2,1.3-0.4,1.9-0.9C392.7,258.5,392.7,257.8,391.9,257z"/>
                      <path strokeWidth='1' stroke='#ea8823' className="st0" d="M121.1,246.4c-3.6,0.9-7.1,1.8-10.7,2.7c-1.8,0.5-3.5,0.9-5.3,1.5c-0.6,0.2-1,0.2-1.5-0.1
